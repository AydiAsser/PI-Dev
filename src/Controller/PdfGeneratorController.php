...
class PdfGeneratorController extends AbstractController
{
    ...
    public function index(EntityManagerInterface $entityManager): Response
    {
        ...
        $imageSrc = $this->imageToBase64($this->getParameter('kernel.project_dir') . '/public/images/Logo_ESPRIT_Ariana.jpg');
        ...
        if (empty($moyTransports)) {
            ...
            $data = [
                ...
                'imageSrc' => $imageSrc,
                'imageSrc1'  => $this->imageToBase64($this->getParameter('kernel.project_dir') . '/public/images/rayen.jpg'),
