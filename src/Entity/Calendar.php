...
class Calendar
{
    ...
    #[ORM\Column(length: 7)]
    private ?string $backgroung_color = null;
    ...
    {
        return $this->backgroung_color;
    }

    public function setBackgroungColor(string $backgroung_color): static
    {
        $this->backgroung_color = $backgroung_color;
